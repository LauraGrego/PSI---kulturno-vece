...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="moderatorDogadjaj.js"></script>
...
/**
 * Fja za brisanje dogadjaja sa moderatorske stranice
 */
if ($requestType=='ajax2'){
    echo 2;
    $opis = $_POST['opis'] ?? null;
    $query = "UPDATE desavanja.Desavanja SET zavrsilo = 1 WHERE opis = :opis";
    $statement = $pdo->prepare($query);
